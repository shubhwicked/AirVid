...
void CameraRecord::FaceDetector(std::vector<mobisoft::FaceDetectionReport*>& face_detection) {
...
int CameraRecord::GetCameraFacing() {
    ...
    jmethodID camera_facing_method_id = env->GetMethodID(
            clazz, "getCameraFacing", "()Lcom/mobisoft/camera/Facing;");
...
void CameraRecord::GetFaceDetectionReports(std::vector<FaceDetectionReport*>& face_detection_reports) {
    ...
    if (nullptr != clazz) {
        jmethodID face_detection_report_method_id = env->GetMethodID(clazz,
                ...
                "()[Lcom/mobisoft/face/FaceDetectionReport;");
...
void CameraRecord::HandleMessage(mobisoft::Message *msg) {
