...
//
// Created by Shubham on 2020-12-20.
//
...
//        stbi_write_png("/Users/Shubham/Desktop/offscreen.png",
...
int FaceMakeupV2SubEffect::OnDrawFrame(FaceDetection* face_detection, std::list<mobisoft::SubEffect *> sub_effects,
                                       int origin_texture_id, int texture_id,
                                       int width, int height, uint64_t current_time) {
...
void Effect::SetFaceDetection(mobisoft::FaceDetection *face_detection) {
