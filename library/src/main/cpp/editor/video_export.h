...
//
// Created by Shubham on 2020-06-15.
//

#ifndef MOBISOFT_VIDEO_EXPORT_H
#define MOBISOFT_VIDEO_EXPORT_H
...
class VideoExport {
 ...
 private:
    ...
    std::deque<mobisoft::Resample*> resample_deque_;
