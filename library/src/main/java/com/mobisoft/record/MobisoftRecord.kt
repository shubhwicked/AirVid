...
import com.mobisoft.Constants
import com.mobisoft.ErrorCode
import com.mobisoft.OnRecordingListener
import com.mobisoft.camera.*
import com.mobisoft.core.Frame
import com.mobisoft.core.MusicInfo
import com.mobisoft.core.RenderType
import com.mobisoft.encoder.MediaCodecSurfaceEncoder
import com.mobisoft.face.FaceDetection
import com.mobisoft.face.FaceDetectionImageType
import com.mobisoft.face.FaceDetectionReport
import com.mobisoft.face.FlipType
import com.mobisoft.listener.OnRenderListener
import com.mobisoft.player.AudioPlayer
import com.mobisoft.record.exception.AudioConfigurationException
import com.mobisoft.record.exception.InitRecorderFailException
import com.mobisoft.record.service.PlayerService
import com.mobisoft.record.service.RecorderService
import com.mobisoft.record.service.impl.AudioRecordRecorderServiceImpl
import com.mobisoft.util.Timer
import java.io.File


class MobisoftRecord(
  val context: Context,
  preview: MobisoftPreviewView
) : MobisoftPreviewView.PreviewViewCallback, Timer.OnTimerListener, CameraCallback {
...
//    mAudioPlayer?.seek()
  ...
  /**
   * 添加滤镜
   * 如: content.json的绝对路径为 /sdcard/Android/com.example.airvid/cache/filters/config.json
   * 传入的路径只需要 /sdcard/Android/com.example.airvid/cache/filters 即可
  ...
  /**
   * 添加特效
   * 如: content.json的绝对路径为 /sdcard/Android/com.example.airvid/cache/effects/config.json
   * 传入的路径只需要 /sdcard/Android/com.example.airvid/cache/effects 即可
   * 如果当前路径不包含config.json则添加失败
   * @param configPath 滤镜config.json的父目录
   * @return 返回当前特效的唯一id
   */
