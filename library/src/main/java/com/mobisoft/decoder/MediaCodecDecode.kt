...
class MediaCodecDecode {
  ...
  fun start(textureId: Int, codecName: String, width: Int, height: Int,
    ...
    try {
      Log.i("mobisoft", "enter MediaCodec Start textureId: $textureId codecName: $codecName width: $width height: $height")
    ...
    Log.i("mobisoft", "leave MediaCodec Start")
  }

  fun stop() {
    Log.i("mobisoft", "enter MediaCodec Stop")
    flush()
    mMediaCodec?.stop()
    mMediaCodec?.release()
    ...
    mMediaCodec = null
    mFormat = null
    Log.i("mobisoft", "leave MediaCodec Stop")
  }
