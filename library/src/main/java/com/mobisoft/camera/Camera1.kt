...
/**
 * Created by Shubham on 2020-07-15
 */
...
class Camera1(
  ...
  private fun openCamera(resolution: PreviewResolution): Int {
    ...
    Log.i("mobisoft", "request preview width: ${resolution.width} height: ${resolution.height}")
    try {
    ...
    Log.i("mobisoft", "setPreviewSize width: ${size.width} height: ${size.height}")
