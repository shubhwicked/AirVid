...
#define LOGV( FMT, ...)  __LOG__(kLevelVerbose, MOBISOFT_TAG, FMT, ##__VA_ARGS__)
#define LOGD( FMT, ...)  __LOG__(kLevelDebug, MOBISOFT_TAG, FMT, ##__VA_ARGS__)
#define LOGI( FMT, ...)  __LOG__(kLevelInfo, MOBISOFT_TAG, FMT, ##__VA_ARGS__)
#define LOGW( FMT, ...)  __LOG__(kLevelWarn, MOBISOFT_TAG, FMT, ##__VA_ARGS__)
#define LOGE( FMT, ...)  __LOG__(kLevelError, MOBISOFT_TAG, FMT, ##__VA_ARGS__)
