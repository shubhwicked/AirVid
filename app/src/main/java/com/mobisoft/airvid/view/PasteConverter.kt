...
import com.mobisoft.airvid.entity.EffectCaption
import com.mobisoft.airvid.entity.EffectPaste
import com.mobisoft.airvid.entity.EffectText
import com.mobisoft.airvid.entity.PasteDescriptor
...
class PasteConverter {
  ...
  fun fillDescription(paste: EffectPaste, descriptor: PasteDescriptor) {
    if (pasteWidth != 0 && mDisplayWidth != 0 && mDisplayHeight != 0) {
      ...
      Log.e("mobisoft", "Please set valid ConvertWidthAndHeight")
    }
  }
