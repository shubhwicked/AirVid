...
import com.mobisoft.OnRecordingListener
import com.mobisoft.camera.CameraCallback
import com.mobisoft.camera.Facing
import com.mobisoft.camera.Flash
import com.mobisoft.camera.MobisoftPreviewView
import com.mobisoft.core.Frame
import com.mobisoft.core.MusicInfo
import com.mobisoft.face.MnnFaceDetection
import com.mobisoft.listener.OnRenderListener
import com.mobisoft.record.PreviewResolution
import com.mobisoft.record.Speed
import com.mobisoft.record.MobisoftRecord
...
import com.mobisoft.airvid.fragment.*
import com.mobisoft.airvid.view.LineProgressView
import com.mobisoft.airvid.view.RecordButton
import com.mobisoft.airvid.view.foucs.AutoFocusTrigger
import com.mobisoft.airvid.view.foucs.DefaultAutoFocusMarker
import com.mobisoft.airvid.view.foucs.MarkerLayout
import java.text.SimpleDateFormat
import java.util.*

/**
 * Create by Shubham on 2020/4/2-下午3:14
 */
class RecordActivity : AppCompatActivity(), OnRecordingListener, OnRenderListener, RecordButton.OnGestureListener,
  ...
  private lateinit var mRecord: MobisoftRecord
...
//    openLog()
    ...
    val preview = findViewById<MobisoftPreviewView>(R.id.preview)
    mLineView = findViewById(R.id.line_view)

    mRecord = MobisoftRecord(this, preview)
...
//        }
  ...
  override fun onDown() {
    ...
    Log.i("mobisoft", "duration: $duration size: ${mRecordDurations.size}")
    if (duration >= mRecordDuration) {
      Toast.makeText(this, "The maximum time has been reached", Toast.LENGTH_LONG).show()
      return
    }
...
//  private fun openLog() {
//    val logPath = Environment.getExternalStorageDirectory().absolutePath + "/mobisoft"
//    if (BuildConfig.DEBUG) {
//      Xlog.appenderOpen(Xlog.LEVEL_DEBUG, Xlog.AppednerModeAsync, "", logPath, "mobisoft", 0, "")
