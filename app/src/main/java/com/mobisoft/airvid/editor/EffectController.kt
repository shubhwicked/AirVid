...
import com.mobisoft.airvid.view.OverlayThumbLineBar
import com.mobisoft.airvid.view.ThumbLineOverlay
import java.util.*

class EffectController(private val context: Context, private val videoEditor: MobisoftVideoEditor) {
