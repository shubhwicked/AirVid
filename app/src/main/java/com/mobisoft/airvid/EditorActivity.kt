...
import com.mobisoft.editor.MediaClip
import com.mobisoft.editor.TimeRange
import com.mobisoft.editor.MobisoftVideoEditor
import com.mobisoft.listener.OnRenderListener
import com.mobisoft.airvid.editor.*
import com.mobisoft.airvid.entity.*
import com.mobisoft.airvid.entity.Filter
import com.mobisoft.airvid.fragment.MusicFragment
import com.mobisoft.airvid.listener.OnEffectTouchListener
import com.mobisoft.airvid.view.*
...
class EditorActivity : AppCompatActivity(), ViewOperator.AnimatorListener, TabLayout.BaseOnTabSelectedListener<TabLayout.Tab>, ThumbLineBar.OnBarSeekListener, PlayerListener, OnEffectTouchListener, OnRenderListener {
  ...
  private lateinit var mVideoEditor: MobisoftVideoEditor
...
//  private val mEffects = LinkedHashMap<String, EffectInfo>()
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    mVideoEditor = MobisoftCore.createEditor(this)
//    openLog()
...
//    mVideoEditor.insertClip(clip)
  ...
  private fun changePlayResource() {
      //hdjehfdjhrjghjtkj(:if(mVideoEditor.)
  }
  ...
  private fun addTabLayout() {
    ...
    mTabLayout.addTab(mTabLayout.newTab().setText(R.string.filter)
        .setIcon(R.mipmap.ic_launcher), false)
